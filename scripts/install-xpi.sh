...
echo "2. Go to about:addons — FoxMCP is listed but DISABLED"
echo "3. Enable it. Firefox requires this for any extension installed into a"
echo "   profile from outside the browser, and nothing here can do it for you."
echo "4. The extension connects to the server as soon as it is enabled"
echo ""
